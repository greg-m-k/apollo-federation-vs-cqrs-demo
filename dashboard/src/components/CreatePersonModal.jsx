...
function CreatePersonModal({ isOpen, onClose, onSubmit }) {
      ...
      >
        ...
        <div className="mt-4 p-3 bg-gray-50 rounded-lg text-xs text-gray-500">
          ...
          <ul className="mt-1 space-y-1">
            <li>• Federation: GraphQL mutation → immediate response</li>
            <li>• Event-Driven: POST → Kafka → Consumer → Projection</li>
          </ul>
        </div>
      </div>
    </div>
